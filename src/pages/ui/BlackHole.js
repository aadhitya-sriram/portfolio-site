...
const fragmentShader = `
  ...
  void main() {
      ...
      for(int i = 0; i < MAX_STEPS; i++) {
          ...
          // 1. GRAVITATIONAL LENSING - Bend light rays towards the black hole
      ...
      float outerGlow = exp(-glowRadius * 3.5) * 0.5; 
      ...
      // Photon Ring
      col += vec3(1.0, 0.8, 0.5) * (0.01 / abs(length(uv) - 0.20));
